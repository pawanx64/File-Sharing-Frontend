...
export const Download = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center gap-12 mt-16 mb-24 p-6">
      ...
      <div className="border-2 border-dashed border-gray-300 p-4 rounded-lg shadow-md bg-white">
        ...
        <button
          ...
          className="mt-4 bg-blue-600 text-white hover:bg-blue-700 transition duration-300 ease-in-out text-xl px-6 py-2 rounded-full shadow-md focus:outline-none"
        >
          Download
        </button>
        {downloadProgress > 0 && (
